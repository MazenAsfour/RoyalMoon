    ...
    <div id="fh5co-services" class=" container">
        <div class="row animate-box">
            <div class="col-md-12 col-md-offset-2 text-center fh5co-heading">
                ...
                <h2>My Favourites</h2>
                <p>Browser application which, like a bookmark, enables links to any website to be saved, thereby facilitating their future consultation. A website's objective is to gain customer loyalty to the extent that they add it to their list of favourites.                </p>
            </div>
        </div>
            ...
            <div class="col-md-4 text-center animate-box mt-20">
                <div class="product">
                    ...
                    <div class="desc" style="text-align: initial;">
                        ...
                        @auth
                            <button class="w-100 btn-primary btn mt-40" onclick="RemoveFromFaviourte({{ $product->id }},{{Auth::user()->id}})"><i class="icon-heart"></i> Remove From
                            Favourite</button>
                        @endauth

    ...
    <div id="content">
            ...
            <div class="container-fluid">
                <div class="row column_title">
                    <div class="col-md-12">
                        <div class="page_title">
                            <h2 style="display: inline-block">Apartment</h2>
                ...
                {{-- <div id="exTab1">
                    <ul class="nav nav-pills">
                        <li class="active">
                            <a href="#1a" data-toggle="tab">ِApartments</a>
                        </li>
                        <li>
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    @foreach ($Apartments as $Apartment)
                                        <tr id="{{ $Apartment->id }}">
                                            <td>{{ $Apartment->id }}</td>
                                            <td><img id="{{ $Apartment->id }}img"
                                                    onclick="lanuchModalImage({{ $Apartment->id }})"
                                                    src="{{ $Apartment->product_image_path }}"
                                                    style="width:60px;height:60px;border-radius:100%"class="img-responsive pointer"
                                                    alt="#" /></td>
                                            <td id="{{ $Apartment->id }}name">{{ $Apartment->product_name }}</td>
                                            <td id="{{ $Apartment->id }}price">${{ $Apartment->product_price }}</td>
                                            <td id="{{ $Apartment->id }}desc"style="width:520px">
                                                {{ $Apartment->product_description }}</td>
                                            <td>{{ $Apartment->created_at }}</td>
                                            <td><i class="fa fa-pencil pointer"
                                                    onclick="lanuchModalUpdate({{ $Apartment->id }})"
                                                    aria-hidden="true"></i>
                                            </td>
                                            <td><i class="fa fa-times pointer"
                                                    onclick="lanuchModalDelete({{ $Apartment->id }})"
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    @foreach ($campings as $camping)
                                        <tr id="{{ $camping->id }}">
                                            <td>{{ $camping->id }}</td>
                                            <td><img id="{{ $camping->id }}img"
                                                    onclick="lanuchModalImage({{ $camping->id }})"
                                                    src="{{ $product->product_image_path }}"
                                                    style="width:60px;height:60px;border-radius:100%"class="img-responsive pointer"
                                                    alt="#" /></td>
                                            <td id="{{ $camping->id }}name">{{ $camping->product_name }}</td>
                                            <td id="{{ $camping->id }}price">${{ $camping->product_price }}</td>
                                            <td id="{{ $camping->id }}desc"style="width:520px">
                                                {{ $camping->product_description }}</td>
                                            <td>{{ $camping->created_at }}</td>
                                            <td><i class="fa fa-pencil pointer"
                                                    onclick="lanuchModalUpdate({{ $camping->id }})"
                                                    aria-hidden="true"></i>
                                            </td>
                                            <td><i class="fa fa-times pointer"
                                                    onclick="lanuchModalDelete({{ $camping->id }})"
                                                    aria-hidden="true"></i></td>
                                        </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="modal-dialog d-flex justify-content-center">
                <div class="modal-content w-100">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Add Apartment</h5>
                            ...
                            <div class="row">
                                <div class="small-12 medium-2 large-2 columns">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" id="">Apartment Name</label>
                                        <input type="text" id="pr_name" name="pr_name" required
                                            class="form-control" />
                                    </div>
                                    <div class="form-outline mb-4">
                                        <label class="form-label" id="">Apartment Price(Per Day)</label>
                                    ...
                                    {{-- <div class="form-outline mb-4">
                                        <label class="form-label" id="">Product Catogory</label>
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" id="">Apartment Description</label>
                                    ...
                                    <div class="alert alert-success-insert alert-success ds-none"
                                        ...
                                        Add Apartment Successfully
                                    </div>
                                    <!-- Submit button -->
                                    <button type="submit" class="btn btn-primary btn-block">Add Apartment
                                    </button>
                        ...
                        <form id="form-update" action="/upload-image" method="POST">
                            ...
                            <div class="row">
                                <div class="small-12 medium-2 large-2 columns">
                                    ...
                                    <input type="hidden" name="type" value="product">
                                    <input type="hidden" name="id" id="product_id_update">
                                    ...
                                    <!-- Submit button -->
                                    <button type="submit" class="btn btn-primary btn-block">Update Product
                                    </button>
        ...
        <div class="modal fade modal-delete" id="modal-delete" tabindex="-1" aria-labelledby="exampleModalLabel1"
            ...
            <div class="modal-dialog d-flex justify-content-center">
                <div class="modal-content w-100">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Product Want To Delete it</h5>
                    ...
                    <div class="alert alert-success ds-none" style="padding:8px 12px;font-size:14px;margin:0 10px 10px "
                        role="alert">
                        Deleted Product Seccuessfully
                    </div>
                    <div class="modal-footer text-right">
                        <button class="btn btn-light" onclick="hideModal()">Cancel</button>
                        <button class="btn btn-primary" onclick="deleteProduct()">Confirm And Delete</button>
            ...
            function addProduct() {
                $.ajax({
                    ...
                    data: {
                        ...
                        "_token": $('#token').attr('content'),
                        "pr_image_link": "image",
                        // "cagtory":$(".form-check-input:checked").val()
                    }, // serializes the form's elements.
                    success: function(data) {
                        console.log(data)
                        data1 = JSON.parse(data);
                        console.log(id)
                        $("#product_id").val(data1.id);
                        return data1.id;
                    }
                });
            }
